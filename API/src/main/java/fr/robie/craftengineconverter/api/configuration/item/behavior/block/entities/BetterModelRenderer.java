...
public class BetterModelRenderer implements EntityRenderer {
    ...
    // Setters
    public BetterModelRenderer setModel(String model) { this.model = model; return this; }
    public BetterModelRenderer setPosition(String position) { this.position = position; return this; }
    public BetterModelRenderer setYaw(Float yaw) { this.yaw = yaw; return this; }
    public BetterModelRenderer setPitch(Float pitch) { this.pitch = pitch; return this; }
    public BetterModelRenderer setSightTrace(Boolean sightTrace) { this.sightTrace = sightTrace; return this; }
